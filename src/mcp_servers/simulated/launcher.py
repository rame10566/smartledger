...
Starts all 13 simulated MCP servers in separate processes.
...
def _run_integration_system() -> None: _run_server("mcp_servers.simulated.integration.server",        8022)
...
_SERVERS = [
    ...
    ("integration_system", 8022, _run_integration_system),
]
